			...
			<div className="relative z-[10000] max-w-5xl mx-auto px-4">
				<div className="text-center space-y-6">
					...
					<div className="relative inline-block px-4 sm:px-0">
						...
						<h1 className="relative text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-800 dark:from-white dark:to-gray-300 pb-2">
							Ethan Chiu
						</h1>
					</div>
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						<div className="flex flex-col items-center gap-4">
							<div className="flex items-center gap-3">
								<span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
                                    <h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-600 dark:text-blue-400">AI-Focused Full-Stack Developer</h2>
                                <span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
							</div>
						...
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['FastAPI','LangChain','ChromaDB','OpenAI','LLaMA 3','React','Next.js',].map((tech) => (
								<span
									key={tech}
									className="px-3 sm:px-4 py-1 sm:py-1.5 bg-gray-100 dark:bg-[#1A1F2B] rounded-full text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-[#2D333B] hover:border-blue-500/50 transition-colors"
								>
									{tech}
								</span>
							))}
					...
					<div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-8 sm:mt-12 px-4 sm:px-0">
						<a href="#work" className="group relative inline-flex items-center justify-center">
							...
							<span className="relative px-6 sm:px-8 py-3 bg-white dark:bg-[#161B22] rounded-full inline-flex items-center justify-center w-full sm:w-auto">
								View My Work
						...
						<a
							href="#contact"
							className="px-6 sm:px-8 py-3 bg-gray-100 dark:bg-[#21262D] rounded-full hover:bg-gray-200 dark:hover:bg-[#2D333B] transition-colors border border-gray-200 dark:border-[#2D333B] hover:border-gray-300 dark:hover:border-gray-600 text-center"
						>
							Get in Touch
						</a>
					</div>
					...
					<div className="flex justify-center gap-4 sm:gap-6 mt-8 sm:mt-12">
                        {/* GitHub */}
                        <a
                            href="https://github.com/Yi-ChiChiu0520"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative p-2 sm:p-3 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                            aria-label="GitHub"
                        >
                        ...
                        {/* LinkedIn */}
                        <a
                            href="https://www.linkedin.com/in/ethan-chiu-cyc/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative p-2 sm:p-3 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                            aria-label="LinkedIn"
